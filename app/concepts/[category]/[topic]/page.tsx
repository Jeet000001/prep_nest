...
const topicFiles: Record<string, Record<string, string>> = {
  ...
  css: {
    ...
    units: "Units.json",
    "positioning-elements": "Positioning_Elements.json",
  ...
  javascript: {
    ...
    "numbers-math": "Numbers_&_Math.json",
    ...
    "event-handling": "Event_Handling.json",
    dom: "DOM.json",
