        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex h-16 items-center justify-between border-b border-[#E7B14C]/20 bg-[#0D0B09]/60 px-4 backdrop-blur-2xl shadow-[0_10px_50px_rgba(0,0,0,0.35)] sm:px-6 lg:h-18 lg:rounded-full lg:border lg:px-8">
            ...
            <nav className="hidden items-center gap-9 lg:flex xl:gap-12">
              <Link
                href="/"
                className="font-mono text-sm text-neutral-400 transition-colors duration-300 hover:text-amber-400"
              >
                Concepts
              </Link>
            ...
            {/* Desktop CTA */}
            <button className="hidden h-11 items-center gap-2 rounded-full bg-amber-400 px-6 font-mono text-sm font-semibold text-black transition-all duration-500  lg:flex">
              Start Exploring
              <ArrowRight size={18} />
            </button>
